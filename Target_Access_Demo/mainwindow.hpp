...
class IARRemoteAccessThread: public QThread
{
    Q_OBJECT
public:
    IARRemoteAccessThread();
    ~IARRemoteAccessThread();
    QByteArray readAll();
    int open(QString IP, QString port, QString data_format, QString Int);
...
private:
    QByteArray rdata;
    QString _data_format;
    QStringList _data_format_list;
    int Int;
...
private:
    ...
    IARRemoteAccessThread *myIARRemoteAccessThread;
